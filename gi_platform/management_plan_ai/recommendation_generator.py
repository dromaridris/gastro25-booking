"""Management AI recommendation generator — Gastro25."""
...
from gi_platform.management_plan_ai.permissions import require_management_plan_ai_use
    ...
    def generate(
        ...
        prompt_engine.register_blocks(
            ...
            [
                ...
                PromptBlock(
                    block_id='management_instruction', category='task',
                    content=(
                        'Suggest management plan items for physician review only. '
                        'Do NOT prescribe medications or place orders automatically.'
                    ),
                ),
        ...
        try:
            ...
            log_event(
                self.db, action='management_plan_ai.ai_generation',
