...
from gi_platform.decision_support.context import AssessmentContext, AssessmentResult, InterviewStepResult
from gi_platform.decision_support.engines.adaptive_history_engine import (
    interview_has_pending_questions,
    recommend_next_questions,
)
from gi_platform.decision_support.engines.branch_engine import active_branches
...
class ClinicalInterviewDriver:
    ...
    def on_answer(self, context: AssessmentContext, question_code: str, answer: str) -> InterviewStepResult:
