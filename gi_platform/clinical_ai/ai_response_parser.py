"""Provider-independent AI response parsing — ported from GastroIntelligence."""
...
from gi_platform.clinical_ai.constants import (
    SECTION_BULLET_LIST, SECTION_NARRATIVE, SECTION_RECOMMENDATIONS,
    SECTION_REFERENCES, SECTION_STRUCTURED, SECTION_TABLE,
)
from gi_platform.clinical_ai.models import ParsedAIResponse, ParsedSection
    ...
    def parse(self, raw_text: str) -> ParsedAIResponse:
        ...
        for title, body in sections.items():
            ...
            if key == 'NARRATIVE':
                ...
                parsed.sections.append(ParsedSection(SECTION_NARRATIVE, title, body.strip()))
            elif key == 'BULLETS':
