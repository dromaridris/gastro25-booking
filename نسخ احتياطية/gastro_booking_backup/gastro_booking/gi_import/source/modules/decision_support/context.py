"""Assessment context and result models for the CDS engine."""
...
class AssessmentContext:
    """Inputs for a single decision-support evaluation — no storage coupling."""
...
class InterviewStepResult:
    """Immediate CDS snapshot after each interview step — drives active history taking."""
