...
from app.modules.decision_support.engines.adaptive_history_engine import recommend_next_questions
...
class DecisionSupportOrchestrator:
    """Central reasoning layer — specialty-independent, KL-backed."""
