"""AI history generation using Clinical AI infrastructure components."""
...
from app.modules.clinical_history_ai.permissions import require_ai_generation


class HistoryAIGenerator:
    """Generates history drafts via 9A infrastructure — no modifications to clinical_ai module."""
    ...
    def generate(
        ...
        *,
        ...
        require_ai_generation(acting_user)
