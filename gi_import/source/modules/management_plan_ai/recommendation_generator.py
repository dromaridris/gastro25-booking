...
from app.modules.management_plan_ai.permissions import require_management_plan_use
...
class ManagementRecommendationGenerator:
    ...
    def generate(
        ...
        *,
        ...
        require_management_plan_use(acting_user)
        ...
        prompt_engine.register_blocks(
            ...
            [
                ...
                PromptBlock(
                    block_id="management_instruction",
                    category="task",
                    content=(
                        "Suggest management plan items for physician review only. "
                        "Do NOT prescribe medications. Do NOT calculate dosing. "
                        "Do NOT place treatment orders or schedule procedures automatically. "
                        "Do NOT modify patient records. Base suggestions on working diagnosis, "
                        "clinical assessment, investigation results, and knowledge references. "
                        "Cover treatment considerations, monitoring, follow-up, patient education, "
                        "safety, and referral where appropriate."
                    ),
                ),
                PromptBlock(
        ...
        try:
            ...
            audit_engine.log(
                action="management_plan_ai.ai_generation",
                user=acting_user,
