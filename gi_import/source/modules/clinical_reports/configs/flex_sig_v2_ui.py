"""Flex sig v2 — UI wiring."""

from flask import request

from app.modules.clinical_reports.configs import flex_sig_v2_forms
...
PHASE_FORMS = {
    WF_CONTEXT: ("context", flex_sig_v2_forms.FlexSigContextForm, flex_sig_v2_forms.bind_context_form),
    WF_ACCESS: ("procedure", flex_sig_v2_forms.FlexSigProcedureForm, flex_sig_v2_forms.bind_procedure_form),
    WF_IMAGING: ("findings", flex_sig_v2_forms.FlexSigFindingsForm, flex_sig_v2_forms.bind_findings_form),
    WF_THERAPY: ("interventions", flex_sig_v2_forms.FlexSigInterventionsForm, None),
    WF_CLOSURE: ("closure", flex_sig_v2_forms.FlexSigClosureForm, flex_sig_v2_forms.bind_closure_form),
    WF_SYNTHESIS: ("synthesis", flex_sig_v2_forms.FlexSigSynthesisForm, flex_sig_v2_forms.bind_synthesis_form),
}
...
TIMELINE_FORM = flex_sig_v2_forms.FlexSigTimelineForm
...
def extract_phase_data(phase_key: str) -> dict:
    ...
    if phase_key == "procedure":
        return {
            ...
            "scope_limit_reached": request.form.get("scope_limit_reached", ""),
    ...
    if phase_key == "findings":
        data = {}
        for key in flex_sig_v2_forms.FINDING_SEGMENT_KEYS:
        ...
        segment_ctx.append(
            {
                ...
                "show_abnormal": field_visible(fsd, sp, f"flex_sig_v2.findings.{key}_findings"),
            }
        )
    return {
        "form": form,
        ...
        "yes_no_choices": flex_sig_v2_forms.YES_NO_CHOICES,
        "show_limited_exam_reason": field_visible(fsd, sp, "flex_sig_v2.procedure.limited_exam_reason"),
        "show_complication_types": field_visible(fsd, sp, "flex_sig_v2.closure.complication_types"),
        "show_complication_detail": field_visible(fsd, sp, "flex_sig_v2.closure.complication_detail"),
        "show_specimen_details": field_visible(fsd, sp, "flex_sig_v2.closure.specimen_details"),
    }
